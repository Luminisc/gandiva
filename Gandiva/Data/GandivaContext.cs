...
namespace Gandiva.Data
{
    class GandivaContext : DbContext
    {
        ...
        public static GandivaContext Instance { get { return instance ?? (instance = new GandivaContext()); } }

        protected override void OnModelCreating(DbModelBuilder builder)
        {
            /* подгружаем конaигурации сущностей из текущей сборки */
            builder.Configurations.AddFromAssembly(typeof(GandivaContext).Assembly);
